...
train_m4_s4_012 = {
    "path": [
        "networks/m4_s4_v0.json",
        "networks/m4_s4_v1.json",
        "networks/m4_s4_v2.json",
    ],
    "num_machines": 4,
    "num_services": 4,
    ...
    "scan_before_exploit": True,
    "reward_scheme": rewards.final_reward_only,
    "maximum_actions": 100,
}

config = train_m4_s4_012
...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (1, 1, config['observation_space'])  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
        self.action_space = list(range(config['action_space']))  # Fixed list of all possible actions. You should only edit the length
...
class Game(AbstractGame):
    ...
    def legal_actions(self):
        ...
        """
        return list(range(config['action_space']))
